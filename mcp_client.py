    ...
    async def process_query(self, query: str) -> str:
        ...
        while True:
            ...
            if not message.tool_calls:
                break  # Exit loop if no tool calls remain
            ...
            for tool_call in message.tool_calls:
                ...
                tool_args_str = tool_call.function.arguments  # JSON string
            ...
            # Loop back to make the next API call with all tool results included
